...
function App() {
  ...
  const [salesBySore, setSalesByStore] = useState<PieChartConfig>();
  ...
  useEffect(() => {
    makeRequest
      ...
      .catch(() => {
        console.error('Error to fatch sales by store');
      });
  }, [params]);
  ...
  useEffect(() => {
    makeRequest
      ...
      .catch(() => {
        console.error('Error to fatch sales by payment method');
      });
  }, [params]);
    ...
    <>
      ...
      <div className="app-container">
        ...
        <div className="sales-overview-container">
          ...
          <PieChartCard name="Lojas" labels={salesBySore?.labels} series={salesBySore?.series} />
